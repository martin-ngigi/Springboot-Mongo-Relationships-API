...
//public class MongoRelationshipsApplication  implements CommandLineRunner {
public class MongoRelationshipsApplication{

	@Autowired
	private PersonRepository personRepository;

	public static void main(String[] args) {
		SpringApplication.run(MongoRelationshipsApplication.class, args);
	}
